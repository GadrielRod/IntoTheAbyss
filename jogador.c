...
Jogador* jogador_criar(const char* nome, TipoClasse classe_escolhida) {
    ...
    switch (classe_escolhida) {
        case CLASSE_GUERREIRO:  hp = 24; atk = 4; def = 12; dano = 6; break;
        case CLASSE_NECROMANTE: hp = 18; atk = 3; def = 10; dano = 15; break;
        case CLASSE_SACERDOTE:  hp = 36; atk = 2; def = 11; dano = 4; break;
        case CLASSE_HUNTERS:    hp = 18; atk = 6; def = 12;  dano = 5; break;
    }
